...
import { AlertTriangle, CheckCircle, Clock, Image as ImageIcon, RefreshCw } from 'lucide-react';
      ...
      {isRunning ? (
        ...
        <div className="space-y-4">
          ...
          {problematicImages.length > 0 && (
            <div>
              <h4 className="text-md font-semibold mb-3 flex items-center gap-2 text-red-600">
                ...
                Produtos com Problemas de Imagem ({problematicImages.length})
              </h4>
          ...
          {problematicImages.length === 0 && (
            <div className="bg-green-50 border border-green-200 rounded-lg p-4 flex items-center gap-3">
              ...
              <div>
                <div className="font-medium text-green-800">Todas as imagens estão funcionando!</div>
        ...
        <div className="text-center py-8">
          ...
          <div className="text-sm text-gray-500">
            Esta ferramenta irá verificar se todas as URLs de imagem estão funcionando corretamente.
          </div>
        </div>
      )}
    </Card>

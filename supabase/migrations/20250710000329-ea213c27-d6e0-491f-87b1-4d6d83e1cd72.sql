-- Corrigir função update_pedido_status_secure para mapear status corretamente para a tabela orders
...
BEGIN
  ...
  -- Update the pedido status (use proper case for consistency)
  UPDATE pedidos 
...
-- Corrigir função de sincronização para mapear status corretamente para a tabela orders

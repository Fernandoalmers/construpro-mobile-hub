-- Primeiro, vamos verificar e remover triggers problemáticos
DROP TRIGGER IF EXISTS sync_order_status_bidirectional ON public.orders;
DROP TRIGGER IF EXISTS sync_order_status_bidirectional ON public.pedidos;
DROP FUNCTION IF EXISTS public.sync_order_status_bidirectional();

-- Desabilitar o trigger problemático
ALTER TABLE public.pedidos DISABLE TRIGGER IF EXISTS sync_pedidos_status_to_orders_trigger;
